...
ll moveGeneration::white_pawn_moves(ll pawns, ll occupied, ll black) {
...
ll moveGeneration::white_pawn_captures(ll pawns, ll occupied, ll black) {
    ll moves = 0;
    moves |= (pawns << 9) & (~H_FILE & black);
    moves |= (pawns << 7) & (~A_FILE & black);
    return moves;
...
ll moveGeneration::black_pawn_moves(ll pawns, ll occupied, ll white) {
    ll moves = ((pawns >> 8) & ~occupied);
...
ll moveGeneration::black_pawn_captures(ll pawns, ll occupied, ll white) {
    ll moves = 0;
    moves |= (pawns >> 9) & (~A_FILE & white);
    moves |= (pawns >> 7) & (~H_FILE & white);
    return moves;
...
ll moveGeneration::king_moves(ll king) {
    ll moves = 0;
...
ll moveGeneration::knight_moves(ll knights) {
    ll moves = 0;
...
ll moveGeneration::left_ray(ll movers, ll occupied) {
    return (((occupied | H_FILE) - (movers << 1)) ^ (occupied | H_FILE)) & ~H_FILE;
}

ll moveGeneration::right_ray(ll movers, ll occupied) {
...
ll moveGeneration::up_ray(ll movers, ll occupied) {
...
ll moveGeneration::down_ray(ll movers, ll occupied) {
...
ll moveGeneration::down_left_ray(ll movers, ll occupied) {
    ll res = 0;
...
ll moveGeneration::up_left_ray(ll movers, ll occupied) {
    ll res = 0;
...
ll moveGeneration::down_right_ray(ll movers, ll occupied) {
    ll res = 0;
...
ll moveGeneration::up_right_ray(ll movers, ll occupied) {
    ll res = 0;
    for (int i = 0; i < 15; i++) {
        if ((movers & DIAG[i]) != 0) {
