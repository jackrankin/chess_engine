#include "../include/bit_operator.h"

using namespace std;

ll BitManipulation::reverse_bits(ll bits) {
...
ll BitManipulation::horizontal_mirror(ll bits) {
...
ll BitManipulation::aeight_hone_mirror(ll a) {
...
ll BitManipulation::aone_height_mirror(ll a) {
...
void BitManipulation::printBitboard(ll bits) {
    bitset<64> b(bits);
